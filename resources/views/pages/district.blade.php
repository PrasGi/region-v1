            ...
            <form action="{{ route('district.index') }}" method="GET">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" aria-label="Sizing example input" name="search"
                        aria-describedby="inputGroup-sizing-default" placeholder="search by name or regency id">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a type="button" class="btn btn-warning update-btn"
                                        href="{{ route('district.update.form', $data->id) }}">Update</a>
                                </div>
                                <div class="col">
                                    <form action="{{ route('district.destroy', $data->id) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addProvinceModalLabel">Add District</h5>
                ...
                <form action="{{ route('district.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="id" name="regency_id" required>
                        </div>
                        {{-- <div class="mb-3">
